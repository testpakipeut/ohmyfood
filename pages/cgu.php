...
<body class="bg-light-bg text-dark-text">
    ...
    <main class="pt-32 pb-12 max-w-3xl mx-auto px-4">
        <h1 class="text-3xl font-bold text-primary mb-8 text-center">Conditions Générales d'Utilisation</h1>
        <div class="bg-white rounded-xl shadow p-8 space-y-6">
            <h2 class="text-xl font-semibold">1. Objet</h2>
            <p class="text-gray-600">Les présentes conditions générales d'utilisation (CGU) ont pour objet de définir les modalités et conditions d'utilisation du site OhMyFood.</p>
            <h2 class="text-xl font-semibold">2. Accès au service</h2>
            <p class="text-gray-600">Le site est accessible gratuitement à tout utilisateur disposant d'un accès à Internet. Certaines fonctionnalités nécessitent la création d'un compte.</p>
            <h2 class="text-xl font-semibold">3. Données personnelles</h2>
            <p class="text-gray-600">Les données personnelles collectées sont traitées conformément à la politique de confidentialité du site.</p>
            <h2 class="text-xl font-semibold">4. Responsabilité</h2>
            <p class="text-gray-600">OhMyFood ne saurait être tenu responsable des dommages directs ou indirects résultant de l'utilisation du site.</p>
            <h2 class="text-xl font-semibold">5. Modification des CGU</h2>
            <p class="text-gray-600">OhMyFood se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés de toute modification.</p>
        </div>
    </main>
    <!-- Footer -->
