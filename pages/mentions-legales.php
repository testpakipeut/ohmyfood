...
<body class="bg-light-bg text-dark-text">
    ...
    <main class="pt-32 pb-12 max-w-3xl mx-auto px-4">
        <h1 class="text-3xl font-bold text-primary mb-8 text-center">Mentions légales</h1>
        <div class="bg-white rounded-xl shadow p-8 space-y-6">
            <h2 class="text-xl font-semibold">Éditeur du site</h2>
            <p class="text-gray-600">OhMyFood<br>Adresse : Paris, France<br>Email : contact@ohmyfood.fr</p>
            <h2 class="text-xl font-semibold">Hébergement</h2>
            <p class="text-gray-600">Hébergeur : OVH<br>2 rue Kellermann, 59100 Roubaix, France</p>
            <h2 class="text-xl font-semibold">Propriété intellectuelle</h2>
            <p class="text-gray-600">Le contenu du site OhMyFood est protégé par le droit d'auteur. Toute reproduction est interdite sans autorisation.Developpé par TOURE ZOUMEYE</p>
        </div>
    </main>
    <!-- Footer -->
