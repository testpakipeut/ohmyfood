...
<head>
    ...
    <title>Comment ça marche - OhMyFood</title>
...
<body class="bg-light-bg text-dark-text">
    ...
    <main class="pt-32 pb-12 max-w-3xl mx-auto px-4">
        <h1 class="text-3xl font-bold text-primary mb-8 text-center">Comment ça marche</h1>
        <div class="bg-white rounded-xl shadow p-8">
            <ol class="space-y-8">
                <li class="flex items-start gap-4">
                    <span class="bg-secondary text-primary font-bold rounded-full w-10 h-10 flex items-center justify-center text-xl">1</span>
                    <div>
                        <h2 class="text-xl font-semibold mb-1">Recherchez un restaurant</h2>
                        <p class="text-gray-600">Utilisez notre moteur de recherche pour trouver le restaurant idéal selon vos envies et votre localisation.</p>
                    </div>
                </li>
                <li class="flex items-start gap-4">
                    <span class="bg-secondary text-primary font-bold rounded-full w-10 h-10 flex items-center justify-center text-xl">2</span>
                    <div>
                        <h2 class="text-xl font-semibold mb-1">Réservez en ligne</h2>
                        <p class="text-gray-600">Choisissez la date, l'heure et le nombre de personnes, puis confirmez votre réservation en quelques clics.</p>
                    </div>
                </li>
                <li class="flex items-start gap-4">
                    <span class="bg-secondary text-primary font-bold rounded-full w-10 h-10 flex items-center justify-center text-xl">3</span>
                    <div>
                        <h2 class="text-xl font-semibold mb-1">Profitez de votre expérience</h2>
                        <p class="text-gray-600">Rendez-vous au restaurant et vivez un moment gastronomique inoubliable !</p>
                    </div>
                </li>
            </ol>
        </div>
